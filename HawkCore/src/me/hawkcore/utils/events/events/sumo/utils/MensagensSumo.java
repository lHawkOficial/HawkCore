...
@Getter
public class MensagensSumo extends MessagesEvent {
	...
	public MensagensSumo(Event event) {
		super(event);
		title = replace("title");
	...
	public static MensagensSumo get() {
		return (MensagensSumo) Sumo.get().getMessages();
	}
